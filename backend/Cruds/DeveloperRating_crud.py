...
def get_all_developer_ratings(db: Session, skip: int = 0, limit: int = 100):
    """Получить все рейтинги застройщиков"""
    return db.query(DeveloperRating).offset(skip).limit(limit).all() 